...
function Introduction() {
  return (
    <section
      id="Introduction"
      className="section-introduction d-flex flex-column align-items-center justify-content-center text-center px-4 gap-2 pt-5 px-1 px-md-3 px-lg-5">
      <div className="container">
        <h1
          className="section-introduction__heading display-1 pb-4"
          id="intro-title">
          Nice to meet you! I'm{' '}
          <u className="myName text-orange-500">Morgan&nbsp;Ero</u>
        </h1>
        <p
